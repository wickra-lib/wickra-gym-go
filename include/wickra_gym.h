/* wickra-gym C ABI — generated by cbindgen; do not edit by hand. */
...
#define WICKRA_GYM_ERR_NULL -1

// `cmd_json` was not valid UTF-8.
#define WICKRA_GYM_ERR_UTF8 -2

// A panic was caught at the FFI boundary.
#define WICKRA_GYM_ERR_PANIC -3
...
typedef struct WickraGymEnv WickraGymEnv;
...
WickraGymEnv *wickra_gym_new(const char *spec_json);
...
void wickra_gym_free(WickraGymEnv *handle);
...
int32_t wickra_gym_command(WickraGymEnv *handle, const char *cmd_json, char *out, uintptr_t cap);

// The library version as a static NUL-terminated string (do not free).
const char *wickra_gym_version(void);
